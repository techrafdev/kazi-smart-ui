<template>
    ...
    <!-- ================= Category start ========================= -->
		<section class="image-bg" style="background:url(assets/img/banner-2.jpg) no-repeat;" data-overlay="7">
			<div class="container">
				...
				<div class="row">
					...
					<div v-for="service_category in service_categories" :key="service_category.id" class="col-md-3 col-sm-6">
						<div class="category-box" data-aos="fade-up">
							<div class="category-desc">
								...
								<div class="category-detail category-desc-text">
									...
									<p>{{ service_category.count }} Service Providers</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12 mrg-top-40">
						<div class="text-center">
							<a href="javascript:void(0)" class="btn theme-btn btn-m">Browse All Category</a>
						</div>
					</div>
...
export default {
	...
	methods: {
		get_service_category() {
			axios.get(`${urlObject.baseUrl}/service/category/providers`)
			.then((resp) => {

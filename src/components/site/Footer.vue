		...
		<footer class="footer">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-4">
						<h4>Featured Job</h4>
						<p>At Vero Eos Et Accusamus Et Iusto Odio Dignissimos Ducimus Qui Blanditiis.At Vero Eos.</p>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="copyright text-center">
							<p>&copy; Copyright 2018 Jobvivo | Powerd By <a href="../../../themezhub.com/index.html" title="Themez Hub">Themez Hub</a></p>
						</div>
					</div>
				</div>
